<?php
    ...
    if(isset($_POST['submit']))
    {
       ...
       $result = mysqli_query($conexao, "INSERT INTO usuarios(usuario,email,sexo,data_nasc,cidade,estado) 
       VALUES ('$nome','$email','$sexo','$data_nasc','$cidade','$estado')") or die(mysqli_error($con));
    }
